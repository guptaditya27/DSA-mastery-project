...
const nodesData = [
  createNode("root", "DSA Master Patterns", 900, 50, ["Master fundamentals first", "Identify pattern families"], 320, 90, 0, "#6366f1"),
  createNode("arrays", "Arrays & Strings", 50, 200, ["Two pointers, sliding window"], 240, 85, 1, "#10b981", "O(n)", "O(1)", "Sequential processing"),
  createNode("linkedlist", "Linked List", 350, 200, ["Pointers, slow/fast"], 220, 80, 1, "#0ea5a4", "O(n)", "O(1)", "Pointer manipulation"),
  createNode("hashing", "Hash Tables", 650, 200, ["Fast lookups O(1)"], 240, 85, 1, "#f59e0b", "O(1) avg", "O(n)", "Constant time access"),
  createNode("trees", "Trees & Graphs", 950, 200, ["DFS/BFS traversals"], 240, 85, 1, "#3b82f6", "O(V+E)", "O(V)", "Recursive structure"),
  createNode("graphs", "Graphs", 1250, 200, ["Nodes + edges, many algorithms"], 260, 90, 1, "#ef8354", "O(V+E)", "O(V)", "Connectivity & traversal"),
  createNode("trie", "Trie (Prefix Tree)", 1550, 200, ["Prefix search, autocomplete"], 220, 80, 1, "#06b6d4"),
  createNode("search", "Search & Sort", 1850, 200, ["Binary search variations"], 240, 85, 1, "#ef4444", "O(log n)", "O(1)", "Divide search space"),
  createNode("twoptr", "Two Pointers", 0, 350, ["Find pairs, move inward"], 180, 70, 2, "#059669"),
  createNode("sliding", "Sliding Window", 220, 350, ["Track window, optimize"], 180, 70, 2, "#0891b2"),
  createNode("hashmap", "Hash Map", 650, 350, ["Key-value storage"], 180, 70, 2, "#d97706"),
  createNode("bfs", "BFS", 900, 350, ["Level-order traversal"], 180, 70, 2, "#dc2626"),
  createNode("dfs", "DFS", 1100, 350, ["Depth-first traversal"], 180, 70, 2, "#1d4ed8"),
  createNode("binary", "Binary Search", 1750, 350, ["Divide and conquer"], 180, 70, 2, "#7c3aed"),
  createNode("matrix", "Matrix", 1950, 350, ["2D traversal, DP on grids"], 220, 80, 2, "#8b5cf6"),
  createNode("dynamic", "Dynamic Programming", 50, 500, ["Optimal substructure"], 240, 85, 1, "#8b5cf6", "O(n²)", "O(n)", "Build solutions bottom-up"),
  createNode("bit", "Bit Manipulation", 350, 500, ["XOR, shifts, masks"], 180, 70, 3, "#2563eb"),
  createNode("greedy", "Greedy", 550, 500, ["Best choice at each step"], 160, 60, 3, "#ca8a04"),
  createNode("backtrack", "Backtracking", 750, 500, ["Try all possibilities"], 160, 60, 3, "#be123c"),
  createNode("stack", "Stack", 950, 500, ["LIFO operations"], 160, 60, 3, "#7c2d12"),
  createNode("queue", "Queue", 1150, 500, ["FIFO operations"], 160, 60, 3, "#0c4a6e"),
  createNode("heap", "Heap (Priority Queue)", 1350, 500, ["Efficient min/max"], 200, 60, 3, "#166534"),
  createNode("unionfind", "Union-Find", 1600, 500, ["Disjoint set, connected components"], 200, 70, 3, "#334155"),
  createNode("segment", "Segment Tree / BIT", 1850, 500, ["Range queries, updates"], 220, 70, 3, "#16a34a"),
  createNode("topo", "Topological Sort", 2100, 500, ["Order DAG nodes"], 200, 60, 3, "#ef4444"),
  createNode("geometry", "Geometry", 2350, 500, ["Coordinates, convex hull"], 220, 60, 3, "#0ea5a4"),
  createNode("prefix", "Prefix Sum", 50, 650, ["Cumulative sums for ranges"], 180, 60, 4, "#db2777"),
];
